...
def get_index(*arg):
    ...
    if len(stats.get('Move')) > 2:
        mookmove_label.place(x=536, y=128)
    else:
...
mookhp_label = tk.Label(win, text="hp", font=("Arial", 20), bg='#fff', fg='#000')
