...
CREATE TABLE cpr.mook_body_armour (
id int,
mookid int,
armourid int,
techupgraded varchar(1)
);
ALTER TABLE cpr.mook_body_armour CHANGE COLUMN id id INT NOT NULL AUTO_INCREMENT , ADD PRIMARY KEY (id);

CREATE TABLE cpr.mook_head_armour (
id int,
mookid int,
armourid int,
techupgraded varchar(1)
);
ALTER TABLE cpr.mook_head_armour CHANGE COLUMN id id INT NOT NULL AUTO_INCREMENT , ADD PRIMARY KEY (id);